-- SEBAS56788 GUI LIBRARY 
-- Creado por Sebas56788
-- https://github.com/sebas56788

local ui_options = {
	main_color = Color3.fromRGB(67, 142, 255),
...
do
	local imgui = game:GetService("CoreGui"):FindFirstChild("Sebas56788_GUI")
...
Toggle.ZIndex = 2
Toggle.Image = "rbxassetid://6031094678"
...
TextBox.PlaceholderText = "🦅 SEBAS Input..."
TextBox.Text = ""
...
Indicator_2.Image = "rbxassetid://6031094678"
Indicator_2.ImageColor3 = Color3.new(1, 1, 1)
...
Toggle_2.Image = "rbxassetid://6031094678"
Toggle_2.ImageColor3 = Color3.new(1, 1, 1)
...
DropdownButton.Text = "      🦅 SEBAS Option"
...
function library:AddWindow(title, options)
	...
	title = tostring(title or "🦅 SEBAS Window")
	...
	do
		...
		do
			function window_data:AddTab(tab_name)
				local tab_data = {}
				tab_name = tostring(tab_name or "🦅 SEBAS Tab")
				...
				do
					function tab_data:AddLabel(label_text)
						label_text = tostring(label_text or "🦅 SEBAS GUI v1.0")
					...
					function tab_data:AddButton(button_text, callback)
						button_text = tostring(button_text or "🦅 SEBAS Button")
					...
					function tab_data:AddSwitch(switch_text, callback)
						...
						switch_text = tostring(switch_text or "🦅 SEBAS Switch")
						callback = typeof(callback) == "function" and callback or function()end
					...
					function tab_data:AddTextBox(textbox_text, callback, textbox_options)
						textbox_text = tostring(textbox_text or "🦅 SEBAS Input...")
						callback = typeof(callback) == "function" and callback or function()end
					...
					function tab_data:AddSlider(slider_text, callback, slider_options)
						...
						slider_text = tostring(slider_text or "🦅 SEBAS Slider")
						callback = typeof(callback) == "function" and callback or function()end
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						keybind_name = tostring(keybind_name or "🦅 SEBAS Keybind")
						callback = typeof(callback) == "function" and callback or function()end
					...
					function tab_data:AddDropdown(dropdown_name, callback)
						local dropdown_data = {}
						dropdown_name = tostring(dropdown_name or "🦅 SEBAS Dropdown")
						callback = typeof(callback) == "function" and callback or function()end
					...
					function tab_data:AddFolder(folder_name)
						...
						folder_name = tostring(folder_name or "🦅 SEBAS Folder")
